...
(defun test-mapl-improper ()
  (let ((sq #'(lambda (x) (cond
			    (x (* (first x) (first x)))
			    (t nil)))))
    (assert-equal (nolisp:mapl-improper sq nil) nil "nil")
    (assert-throws (nolisp:mapl-improper sq 123) 'simple-type-error "atoms")
    (assert-equal (nolisp:mapl-improper sq '(123)) '(15129) "single item list")
    (assert-equal (nolisp:mapl-improper sq '(123 . 456)) 15129 "pair")
    (assert-equal (nolisp:mapl-improper sq '(123 456)) '(15129 207936) "two item list")
    (assert-equal (nolisp:mapl-improper sq '(123 456 . 567)) '(15129 . 207936) "improper triple")))

(defun test-map-improper ()
  (let ((sq #'(lambda (x) (cond
			    ;;((consp x) (* (first x) (rest x)))
			    (x (* x x))
			    (t nil)))))
    (assert-equal (nolisp:map-improper sq nil) nil "nil")
    (assert-equal (nolisp:map-improper sq 123) 15129 "atoms")
    (assert-equal (nolisp:map-improper sq '(123)) '(15129) "single item list")
    (assert-equal (nolisp:map-improper sq '(123 . 456)) '(15129 . 207936) "pair")
    (assert-equal (nolisp:map-improper sq '(123 456)) '(15129 207936) "two item list")
    (assert-equal (nolisp:map-improper sq '(123 456 . 567)) '(15129 207936 . 321489) "improper triple")))

(defun test-mapelt-improper ()
  (let ((sq #'(lambda (x) (cond
			    (x (* x x))
			    (t nil)))))
    (assert-equal (nolisp:mapelt-improper sq nil) nil "nil")
    (assert-throws (nolisp:mapelt-improper sq 123) 'simple-type-error "atoms")
    ;;(assert-equal (nolisp:mapelt-improper sq 123) 15129 "atoms")
    (assert-equal (nolisp:mapelt-improper sq '(123)) '(15129) "single item list")
    (assert-equal (nolisp:mapelt-improper sq '(123 . 456)) '(15129 . 207936) "pair")
    (assert-equal (nolisp:mapelt-improper sq '(123 456)) '(15129 207936) "two item list")
    (assert-equal (nolisp:mapelt-improper sq '(123 456 . 567)) '(15129 207936 . 321489) "improper triple")))
