...
(defun emit-tailcall (asm-stack reg data-offset args callers-bindings &optional (n args))
  ;; todo pop values, pop caller's values moving stack frame over caller's, call
  ;; todo need caller's size
  (emit-call (emit-pop-values asm-stack 1 (+ n callers-bindings)) reg data-offset))
